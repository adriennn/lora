...
Server.errorMessages[Server.errors.INVALID_API_KEY] = 'Invalid Everynet.com API key';
Server.errorMessages[Server.errors.DEVICE_NOT_FOUND] = 'Device note found via Everynet.com API';
